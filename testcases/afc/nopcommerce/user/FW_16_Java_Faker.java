...
public class FW_16_Java_Faker extends BaseTest {
	...
	public void beforeClass(String browserName, String pageUrl) {
		...
		emailAddress = dataFaker.generateEmailAddress();
		password = dataFaker.generatePassword();
		company = dataFaker.generateCompany();
		date = dataFaker.getDobDay();
		month = dataFaker.getDobMonth();
		year = dataFaker.getDobYear();
	}
